...
func CreateTime(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func UpdateTime(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func CreateTimeEQ(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreateTime), v))
	})
}
...
func CreateTimeNEQ(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func CreateTimeIn(vs ...time.Time) predicate.Story {
...
func CreateTimeNotIn(vs ...time.Time) predicate.Story {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreateTimeGT(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func CreateTimeGTE(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func CreateTimeLT(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func CreateTimeLTE(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func UpdateTimeEQ(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUpdateTime), v))
	})
}
...
func UpdateTimeNEQ(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func UpdateTimeIn(vs ...time.Time) predicate.Story {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdateTimeNotIn(vs ...time.Time) predicate.Story {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdateTimeGT(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func UpdateTimeGTE(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func UpdateTimeLT(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func UpdateTimeLTE(v time.Time) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
...
func HasOwnerWith(preds ...predicate.Board) predicate.Story {
	return predicate.Story(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
