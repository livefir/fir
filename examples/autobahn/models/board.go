...
func (e BoardEdges) StoriesOrErr() ([]*Story, error) {
	if e.loadedTypes[0] {
...
// QueryStories queries the "stories" edge of the Board entity.
func (b *Board) QueryStories() *StoryQuery {
	return (&BoardClient{config: b.config}).QueryStories(b)
}
